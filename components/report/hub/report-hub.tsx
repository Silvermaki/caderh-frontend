import { REPORT_CATEGORIES, reportsByCategory } from '@/lib/report/registry';
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">14 reportes operativos de CADERH</p>
      </div>
      <div className="mb-6"><ReportSearch /></div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {REPORT_CATEGORIES.map((meta) => (
          <ReportCategoryCard key={meta.key} meta={meta} reports={reportsByCategory(meta.key)} />
        ))}
      </div>
    </div>
  );
